<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Route.Master" CodeBehind="EditUser.aspx.vb" Inherits="Routes.EditUser" %>
        ...
        <div class="topLeftOuterDiv topLeftOuterDivNPS">
            ...
            <div >
                <table class="addUserTable">
                    ...
                    <tr>
                        <td >Current NPS:</td>
                        <td><asp:TextBox runat="server" ID="txtNPS"  /></td>
                    </tr>
                    <tr>
                        <td >YTD NPS:</td>
                        <td><asp:TextBox runat="server" ID="txtYtdNPS"  /></td>
                    </tr>
                    <tr>
                        <td >Payroll Summary</td>
                        <td><asp:DropDownList runat="server" ID="ddlPayrollSummary" /></td>
                    </tr>
                    <tr>
                        <td ><asp:Label runat="server" ID="lblID" Visible="false" /></td>
